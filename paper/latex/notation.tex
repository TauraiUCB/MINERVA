...
\newcommand{\lonenorm}[1][\cdot]{\norm[#1]_{1}}
\newcommand{\ltwonorm}[1][\cdot]{\norm[#1]_{2}}
...
% Notation for MINE
\newcommand{\jointeval}[1][\cdot]{\mu\left(#1\right)}
\newcommand{\prodeval}[1][\cdot]{\nu\left(#1\right)}
\newcommand{\donskervaradhanloss}{{v}}
\newcommand{\lossfun}{{\ell}}
